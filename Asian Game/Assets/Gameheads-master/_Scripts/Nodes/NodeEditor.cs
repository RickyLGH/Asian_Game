...
public class NodeEditor : EditorWindow
{
    ...
    void OnGUI()
    {
        ...
        if (e.button == 1 && !makeTransitionNode)
        {
            ...
            else
            {
                ...
                menu.AddItem(new GUIContent("Make Transition"), false, ContextCallBack, "Make Transiton");
                menu.AddSeparator("");
    ...
    void ContextCallBack(object obj)
    {
        ...
        {
            OuputNode ouputNode = new OuputNode();
            ouputNode.windowRect = new Rect(mousePos.x, mousePos.y, 200, 150);

            windows.Add(ouputNode);
        }
        ...
        else if (clb.Equals("Make Transition"))
        {
            bool clickedonWindow = false;
            int selectIndex = -1;
        ...
        else if (clb.Equals("Delete Node"))
        {
            bool clickedonWindow = false;
            int selectIndex = -1;
